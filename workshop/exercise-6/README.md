...
3. This time we'll create the secret via a .yaml file. Update the `docker-secret.yaml` file with your base64 encoded password. First, Open the file by clicking the pencil icon in the top right of the terminal, or use the tab you already have open:
